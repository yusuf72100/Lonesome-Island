...
void destroyAll();
extern void drawButton(SDL_Texture *texture, SDL_Rect rectangle, SDL_Surface *surface);
extern void buttonHover(SDL_Surface *button_surface, SDL_Texture *button_texture, SDL_Rect *button_rect, SDL_bool *hover_button);
extern void buttonHoverWithAnimation(SDL_Surface *button_surface, SDL_Texture *button_texture, SDL_Rect *button_rect, SDL_bool *hover_button, void* (*p)(void*), void* (*p2)(void*));
...
extern void *settings_button_animation_right();
static void *settings_button_animation_left();
static void *running_down_animation(void *j);
static void *running_up_animation(void *j);
static void *running_right_animation(void *j);
static void *running_left_animation(void *j);
static void *breathAnimation(void *j);
