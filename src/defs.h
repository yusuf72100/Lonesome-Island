...
typedef enum {PLAY_BUTTON_HOVER, CONNECT_BUTTON_HOVER, HOST_BUTTON_HOVER, SETTINGS_BUTTON_HOVER, SETTINGS_KEYBINDS_HOVER, SETTINGS_KEYBIND_HOVER, INVENTORY_BUTTON_HOVER} T_BUTTONS_HOVER;
typedef enum {PLAY_BUTTON_CLICKED, CONNECT_BUTTON_CLICKED, HOST_BUTTON_CLICKED, SETTINGS_BUTTON_CLICKED, SETTINGS_KEYBINDS_CLICKED, SETTINGS_KEYBIND_CLICKED, INVENTORY_BUTTON_CLICKED} T_BUTTONS_CLICKED;
